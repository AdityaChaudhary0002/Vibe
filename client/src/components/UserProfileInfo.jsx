  ...
  return (
    <div className=" relative py-4 px-6 md:px-8 bg-white dark:bg-slate-900">
      <div className="flex flex-col md:flex-row items-start gap-6">
        <div className="size-32 border-4 border-white dark:border-slate-900 shadow-lg absolute -top-16 rounded-full">
          <img
        ...
        <div className="w-full pt-16 md:pt-0 md:pl-36">
          ...
          <div className="flex items-c gap-6 mt-6 border-t border-gray-200 dark:border-gray-700 pt-4">
            <div>
